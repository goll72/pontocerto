...
const SignupPage: Component = () => {
    ...
    return (
        <Card class="p-4 shadow mx-auto my-4" style="width:350px">
            <Card.Body>
                        ...
                        <OverlayTrigger
                            ...
                            overlay={
                                <Tooltip id="t-why-passkeys">
                                    O certificado digital (ou certificado A1)
                                    serve para realizar a validação da sua
                                    identidade, ou seja, confirmar que você
                                    representa o CPNJ que está tentando
                ...
                <Form.Group class="mb-3">
                    <Form.Label>Escolha uma forma de autenticação</Form.Label>
                    <Form.Check
                        checked
                        type="radio"
                    ...
                    <div class="d-flex flex-row-reverse text-body-secondary">
                        <OverlayTrigger
                            ...
                            overlay={
                                <Tooltip id="t-why-passkeys">
                                    Passkeys são mais seguras que senhas, pois
                                    elas nunca saem do seu dispositivo, e são
                                    mais convenientes para você (usuário), que
                                    não vai ter que se preocupar em memorizar
                                    mais uma senha.
                                </Tooltip>
                            }
                        >
