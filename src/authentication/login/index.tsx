                ...
                <Card.Body>
                    ...
                    <Form.Group class="mb-3">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="/authentication/resetpassword/" class="small">Esqueceu sua senha?</a>
                        </div>
                        <Form.Control type="password" placeholder="Coloque sua senha"></Form.Control>
                    </Form.Group>
                    ...
                    <Button class="w-100 mb-3" variant="dark">
                        <a class="nav-link" href="/home/">Entrar</a>
                    </Button>
                    ...
                    <p class="text-center small mt-3">
                        Não tem conta? <a href="/authentication/register/">Criar conta</a>
                    </p>
                </Card.Body>
            </Card>
